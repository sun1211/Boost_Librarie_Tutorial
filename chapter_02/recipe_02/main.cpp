...
//We cannot deallocate p at the end of the while loop
//because it still can be used by threads that run process functions.
//These process functions cannot delete p,
//because they do not know that other threads are not using it anymore.
