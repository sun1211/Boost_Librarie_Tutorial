...
//we need to define our structure, task_structure, which will be used to store task
struct task_structure {
    // ...
    std::size_t value_;
};

//start writing the work_queue class
class work_queue {
public:
...
public:
    explicit work_queue()
    //Initialization of members must look like the following
        : segment_(
