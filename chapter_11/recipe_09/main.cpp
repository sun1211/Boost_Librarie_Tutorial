...
//The Boost.Coroutine2 library takes care of almost everything. We just need to include its header
#include <boost/coroutine/coroutine.hpp>

//Make a coroutine type with the required input parameter type
typedef boost::coroutines::coroutine< 
    std::string&(std::size_t max_characters_to_process) 
> corout_t;

//Make a class, representing a subprogram
