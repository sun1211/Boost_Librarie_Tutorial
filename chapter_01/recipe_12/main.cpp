...
//we have a class with multiple fields, some of which are standard library containers
struct person_info {
    std::string name_;
...
//we have a portable fast implementation of the move assignment and move construction operators of the person_info class

#include <boost/swap.hpp>

//in the C++03 standard library, containers have neither move operators nor move constructors.
//The correct implementation of the move assignment is the same move constructing an object 
//and swapping it with this. The correct implementation of the move constructor is close
//to the default construct and swap. So, let's start with the swap member function
