...
#include <string>
//The detail::vertex_writer structure, used in the preceding step, must be defined as follows
...
//write the std::ostream operator for graph_type as done in the preceding recipe
